...
function Navbar(props) {
  ...
  return (
    ...
    <Link to="/"  className="navbar-brand">{props.children} Cake Shop</Link><img style={{"height" : "45px"}} src={cakesvg} alt="Cake Online" />
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="form-inline my-2 my-lg-0">
          {console.log("Base Url Routes>>>>>>>>>>>>>>>>>>>>>",props.location.pathname)}
